...
class MCMC_Autocorr:
    ...
    def autocorr_vs_N(self, n=200, c=5, tol=50):
        """
    ...
    def plot_autocorr(self, bin_num, color='k', fig=None, ax=None):
        ...
        if not fig or not ax: 
            ...
            ax.plot(N, N / 50.0, color="black", linestyle=':', label=r"$\tau=N/50$", alpha=0.5)

        ax.plot(N, tau, marker="D", markersize=0, linewidth=0.8, linestyle='-', color=color)
        return fig, ax
