...
class LinearEstimator: 
    ...
    def slope(self, box=None, slopes=None, n_jitter=10): 
        ...
        for _ in tqdm.tqdm(range(n_jitter)):
            ...
            fit_jit = LinearBayes(x_j, y_j, ye_j,
                          box=None, top_fraction=self.top_fraction)
            m_jitter, _, _ = fit_jit.run()      # returns (slope, intercept, σ_stat)
...
if __name__ == "__main__": 
    ...
    filt_combinations = [ 
        #["F115W", "F323N", "F115W", "NRCB1"],
        #["F115W", "F323N", "F115W", "NRCB2"], 
        #["F115W", "F323N", "F115W", "NRCB3"], 
        ["F115W", "F323N", "F115W", "NRCB4"], 
    ]

    slopes = [
        #[(7.5, 21.65), (8, 22.2), 0.1],
        #[(7.5, 21.65), (8.5, 22.85), 0.12], 
        #[(8, 22.265), (8.5, 22.85), 0.12],
        [(8, 22.2), (8.5, 22.82), 0.12]
    ]
    ...
    for idx, comb in enumerate(filt_combinations): 
        ...
        slope_med, intercept, slope_err, slope_sys = est.slope(slopes=slopes[idx], n_jitter=5)
