...
class GenerateRC(): 
    ...
    def plot_CMD(self, save=True): 
        ...
        if hasattr(self, "cutoff_point1"): 
            ax.axline(xy1=self.cutoff_point1, slope=self.cutoff_slope, linestyle='--', c='r')
            ...
            ax.axline(xy1=(self.cutoff_point2[0], upper_cutoff), slope=self.cutoff_slope, linestyle='--', c='cadetblue')
    ...
    def filtered_mags(self, filt1, filt2, filty, region): 
        ...
        print(f"{len(m1)} Red Clump stars found in {region}")
...
class Type1(): 
    ...
    def generate(self, write=True): 
        for comb in self.filt_combinations: 
            ...
            sub_filts = [["F115W", "F323N", "F115W", "NRCB1", "NRCB5", "NRCB1"]]
...
class Type12(): 
    ...
    def generate(self): 
        for comb in self.filt_combinations: 
            ...
            instance = GenerateRC(filt1, filt2, filty, reg1, reg2, regy) 
            instance.plot_hess(filt1, filt2, filty, region=reg1)
...
if __name__ == "__main__": 
    ...
    instance.red_clump_stars(write=False)
    #instance.plot_CMD()
    #instance.plot_hess(filt1="F115W", filt2="F212N", filty="F115W", region="NRCB1") 
